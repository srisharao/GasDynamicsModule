...
def OSMthweak(M,th,k=1.4):
    ...
    Explanantion: Calculates the downstream shock properties of an attached oblique shock given M and theta, weak shock solution
    Usage:
        B=OSMthB(M,th,k=1.4)
    ###
    ver 0
    ...
    if th==thmax:
        ...
        M1n=M*math.sin(B[0])
        M2n=NSM1M2(M1n,k)
        M2=M2n/math.sin(B[0]-th)
        out=[M,M2,NSP2P1(M1n,k),NST2T1(M1n,k),NSrho2rho1(M1n,k),NSP02P01(M1n,k),NSdSbyR(M1n,k),th,B[0]]
        return out
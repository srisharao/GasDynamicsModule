...
def OSths(M,k=1.4):
    ...
    Inputs: M1,k
    Outputs: ths
    Explanantion: Calculates the sonic flow deflection angle at which M2=1 for attached solutions given M and k
    Usage:
